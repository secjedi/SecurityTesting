...
public class XssFetchOrder extends BaseTest {
    ...
    @Test
    public  void  xssFetchOrderTest() throws IOException {
        // 1. Login
        login("admin", "admin");
        ...
        driver.findElement(editClientNumber).sendKeys("<h1>+34568976663</h1>");
        ...
        try{
            ...
            String dest_path = ".idea/resources/screenshots/fetchOrder_test_passed.png";
            ...
            TakesScreenshot camera = (TakesScreenshot)driver;
            File screenshot = camera.getScreenshotAs(OutputType.FILE);
            String dest_path = ".idea/resources/screenshots/fetchOrder_test_failed.png";
            File destination = new File(dest_path);
            System.out.println("Screenshot taken: " +dest_path);
            Files.move(screenshot, destination);
        }
