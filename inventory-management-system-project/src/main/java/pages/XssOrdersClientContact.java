...
public class XssOrdersClientContact extends BaseTest {
    ...
    //private final By dropDownMenuButton = By.id("navOrder");
    ...
    private final By editClientNumber = By.id("clientContact");
    private final By saveOrderButton = By.id("editOrderBtn");
    private final By orderTable= By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[5]/td[4]");
    @Test
    public  void  xssOrdersClientContactTest() throws IOException {
        // 1. Login
        login("admin", "admin");
        ...
        // 3. Change client's contact by inserting a XSS payload
        driver.findElement(editClientNumber).clear();
        driver.findElement(editClientNumber).sendKeys("<h1><b>+34568976663</b></h1>");
        ...
        // 5 Assert that the payload was successfully mounted and take screenshots.
        String actualTitle = driver.findElement(orderTable).getAttribute("innerHTML");
        String expectedTitle = "<h1><b>+34568976663</b></h1>";
        ...
        try{
            ...
            String dest_path = ".idea/resources/screenshots/ordersClientContact_test_passed.png";
    ...
    public void reset() {
        ...
        // 3. Reset client's contact
        driver.findElement(editClientNumber).clear();
        driver.findElement(editClientNumber).sendKeys("+34568976663");
        driver.findElement(saveOrderButton).click();
