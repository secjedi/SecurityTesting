...
public class EditOrdersClientContact extends BaseTest {
    @Test
    public  void  xssTest(){
        // 1. Login
        login("admin", "admin");
        ...
        // 3. Change client's contact by inserting a XSS attack vector
        ...
        // 5 Check the client's contact in the order page
        WebElement orderTable= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[1]/td[4]"));
        String orderLabel = orderTable.getAttribute("innerHTML");
        assertEquals("<h1>+38976663</h1>", orderLabel);
