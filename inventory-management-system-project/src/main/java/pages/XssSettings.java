...
public class XssSettings extends BaseTest {
    ...
    @Test
    public  void  testSettingsTest() throws IOException {
        // 1. Login
        login("admin", "admin");
        // Wait for login
        try {
        ...
        try{
            ...
            String dest_path = ".idea/resources/screenshots/settings_test_passed.png";
            ...
            TakesScreenshot camera = (TakesScreenshot)driver;
            File screenshot = camera.getScreenshotAs(OutputType.FILE);
            String dest_path = ".idea/resources/screenshots/settings_test_failed.png";
            File destination = new File(dest_path);
            System.out.println("Screenshot taken: " +dest_path);
            Files.move(screenshot, destination);
        }
